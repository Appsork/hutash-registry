...
## Install: Three steps to your first generation

**Step 1 — Download and install**

Get the Windows installer from [hutash.com/download](../../download.html) and run it. No account, no sign-in, no licence key.
